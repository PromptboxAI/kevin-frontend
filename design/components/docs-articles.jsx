...
const DOC_ARTICLES_A = {
  ...
  'depreciation-overrides': {
    ...
    blocks: [
      ...
      ['table', [
        ['Method', 'How it works'],
        ['Straight-line (default)', 'Age divided by the useful life for the class. It runs to 100% unless the schedule sets a lower ceiling for that class.'],
      ...
      ['h2', 'How far it runs'],
      ['p', 'Straight-line runs all the way to 100%. An item past its useful life depreciates to an actual cash value of $0.00, and that is the figure Kevin shows — a five-year-life item at five years or older reads 100%.'],
      ['p', 'There is no across-the-board salvage floor. A ceiling applies only where the schedule sets one for that content class, and most classes set none. If your carrier expects a floor, put it in the schedule as a maximum for the classes it should cover, or type over the percentage on the line — both are recorded.'],
      ['h2', 'Overriding'],
      ['p', 'Type a percentage into the cell and it stops following the schedule — the row is marked as manually set, and the change is recorded with your name and the time. Click the information icon in the cell to see how the figure was reached: the method, the useful life, the age, and whether a class ceiling applied.'],
      ...
      ['p', 'On intake, choose Add new schedule to define one: a name, the method, useful life by class, and an optional maximum per class — that maximum is where a salvage floor belongs if you want one. It is then selectable on any future claim.'],
    ],
  },
