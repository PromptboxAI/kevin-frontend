...
| 02 Landing **MktShot** screenshot slots (×3) | landing | — static (visual) | Not a control. Presentational frame in the visual-proof section; renders a labeled drop target until a PNG is passed to `src`. Captures wanted: `73-Photo-staging`, `05-Worksheet-flat`, `06-Export-modal`. |
